...
STORAGES = {
    ...
    "staticfiles": {
        # StaticFilesStorage estándar de Django.
        # WhiteNoise middleware sirve los archivos desde STATIC_ROOT en producción.
...
# WHITENOISE_USE_FINDERS: WhiteNoise también busca archivos en STATICFILES_DIRS
# (directorio fuente) además de STATIC_ROOT. Garantiza que los estáticos se
# sirvan correctamente aunque collectstatic no copie todos los archivos.
