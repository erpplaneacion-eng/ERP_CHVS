...
class AnalisisNutricionalService:
    ...
    def _analizar_nivel_escolar(
        ...
        if analisis_guardado:
            AnalisisNutricionalService._aplicar_pesos_guardados(
                preparaciones_nivel,
                analisis_guardado
            )
