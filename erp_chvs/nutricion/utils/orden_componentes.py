...
ORDEN_COMPONENTES_POR_MODALIDAD = {
    ...
    '020511': ['com18', 'com11', 'com3', 'com12', 'com13'],

    # COMPLEMENTO AM/PM JORNADA UNICA  y  REFUERZO COMPLEMENTO AM/PM PREPARADO
    '20503': ['com2', 'com7', 'com3', 'com8', 'com9', 'com11', 'com14', 'com5', 'com6'],
    '20510': ['com2', 'com7', 'com3', 'com8', 'com9', 'com11', 'com14', 'com5', 'com6'],
}
...
def sort_preparaciones_objetos(preparaciones, modalidad_id):
    ...
    """
    # Siempre omitir com15 (Agua) en todas las modalidades
    preparaciones = [p for p in preparaciones if str(p.id_componente_id or '') != 'com15']
...
def sort_preparaciones_dicts(preparaciones, modalidad_id):
    ...
    """
    # Siempre omitir com15 (Agua) en todas las modalidades
    preparaciones = [p for p in preparaciones if str(p.get('id_componente_id', '') or '') != 'com15']
