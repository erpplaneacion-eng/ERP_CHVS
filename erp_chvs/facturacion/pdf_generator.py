...
DIAS_HABILES_POR_MES = {
    ...
    "ABRIL": [1, 6, 7, 8, 9, 10, 13, 14, 15, 16, 17, 20, 21, 22, 23, 24, 27, 28, 29, 30],  # Festivos: 2(J.Santo), 3(V.Santo)
    "MAYO": [4, 5, 6, 7, 8, 11, 12, 13, 14, 15, 19, 20, 21, 22, 25, 26, 27, 28, 29],  # Festivos: 1(Trabajo), 18(Ascensión)
    "JUNIO": [1, 2, 3, 4, 5, 9, 10, 11, 12, 16, 17, 18, 19, 22, 23, 24, 25, 26, 30],  # Festivos: 8(Corpus), 15(S.Corazón), 29(S.Pedro)
    "JULIO": [1, 2, 3, 6, 7, 8, 9, 10, 13, 14, 15, 16, 17, 21, 22, 23, 24, 27, 28, 29, 30, 31],  # Festivos: 20(Independencia)
    "AGOSTO": [3, 4, 5, 6, 10, 11, 12, 13, 14, 18, 19, 20, 21, 24, 25, 26, 27, 28, 31],  # Festivos: 7(Boyacá), 17(Asunción)
    ...
    "NOVIEMBRE": [3, 4, 5, 6, 9, 10, 11, 12, 13, 17, 18, 19, 20, 23, 24, 25, 26, 27, 30],  # Festivos: 2(T.Santos), 16(Ind.Cartagena)
