"""
Servicio principal de OCR refactorizado.
Utiliza la nueva arquitectura de servicios modulares.

Este archivo reemplaza el antiguo ocr_service.py y proporciona una interfaz
simplificada que delega todo el trabajo a los servicios especializados.
"""
...
def procesar_pdf_ocr_view(archivo_pdf: UploadedFile, usuario=None) -> Dict[str, Any]:
    ...
    Returns:
        Dict con resultados del procesamiento:
            ...
            - sede_educativa: str
    """
    # Crear orquestador y procesar PDF
